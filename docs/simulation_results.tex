...
\begin{itemize}[noitemsep]
    \item KS's greedy approach selects $L=4$ bundles but struggles with the small premium segment
    \item Despite having 4 bundles, KS achieves limited price discrimination in this bimodal market
    \item OT discovers $L=2$ solution: one bundle for regular consumers, one for premium
    \item OT achieves 27.74\% profit improvement by more effectively exploiting market segmentation
