"""
Proper train/test evaluation for Early Adopters scenario
...
print("="*80)
print("PROPER TRAIN/TEST EVALUATION: Early Adopters Scenario")
print("="*80)
print()

# Create train/test split
csv_path = "scenario_early_adopters.csv"
...
t0 = time.time()
bundles_ks, prices_ks = ks.train(train_path, L_max=4)
...
print("Training on train set (trying L=1,2,3,4)...")
best_L = 1
best_bundles = None
best_prices = None
best_train_profit = 0
